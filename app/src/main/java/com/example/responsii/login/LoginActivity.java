package com.example.responsii.login;
...
import com.example.responsii.Data.DataMahasiswa;
import com.example.responsii.R;
import com.example.responsii.SharedPreferences.SharedPreferences;
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    if (username.equals(spUsername) && password.equals(spPassword)) {
                        Intent i = new Intent(LoginActivity.this, DataMahasiswa.class);
